...
namespace DowiezPlBackend.Data
{
    public interface IDowiezPlRepository
    {
        ...
        Task<Opinion> GetOpinionPairAsync(Guid issuerId, Guid ratedId);
        ...
        Task<List<Report>> GetReportsFilterAsync(ReportCategory? category, ReportStatus? status, bool? isAsigned, AppUser assignedTo);
