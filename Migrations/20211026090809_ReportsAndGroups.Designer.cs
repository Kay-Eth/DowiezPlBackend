...
namespace DowiezPlBackend.Migrations
{
    ...
    [Migration("20211026090809_ReportsAndGroups")]
    partial class ReportsAndGroups
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DowiezPlBackend.Models.Report", b =>
                {
                    ...
                    b.Property<Guid?>("ReportedDemandDemandId")
                        .HasColumnType("char(36)");

                    b.Property<Guid?>("ReportedGroupGroupId")
                        .HasColumnType("char(36)");

                    b.Property<Guid?>("ReportedId")
                        .HasColumnType("char(36)");

                    b.Property<Guid?>("ReportedTransportTransportId")
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("ReportedDemandDemandId");

                    b.HasIndex("ReportedGroupGroupId");

                    b.HasIndex("ReportedId");

                    b.HasIndex("ReportedTransportTransportId");
            ...
            modelBuilder.Entity("DowiezPlBackend.Models.Report", b =>
                {
                    ...
                    b.HasOne("DowiezPlBackend.Models.Demand", "ReportedDemand")
                        .WithMany()
                        .HasForeignKey("ReportedDemandDemandId");

                    b.HasOne("DowiezPlBackend.Models.Group", "ReportedGroup")
                        .WithMany()
                        .HasForeignKey("ReportedGroupGroupId");

                    b.HasOne("DowiezPlBackend.Models.AppUser", "Reported")
                        .WithMany("ReferedReports")
                        .HasForeignKey("ReportedId");

                    b.HasOne("DowiezPlBackend.Models.Transport", "ReportedTransport")
                        .WithMany()
                        .HasForeignKey("ReportedTransportTransportId");
                    ...
                    b.Navigation("ReportedDemand");

                    b.Navigation("ReportedGroup");

                    b.Navigation("ReportedTransport");
            ...
            modelBuilder.Entity("DowiezPlBackend.Models.Transport", b =>
                {
                    b.HasOne("DowiezPlBackend.Models.Conversation", "TransportConversation")
                        .WithOne("OwnerTransport")
                        .HasForeignKey("DowiezPlBackend.Models.Transport", "ConversationId");
                    ...
                    b.Navigation("TransportConversation");
                });
